namespace QnSCommunityCount.Logic.Entities.Persistence.App
{
	...
	partial class CostCollection : QnSCommunityCount.Contracts.Persistence.App.ICostCollection
	{
		...
		protected bool Equals(QnSCommunityCount.Contracts.Persistence.App.ICostCollection other)
		{
			...
			return Id == other.Id && IsEqualsWith(RowVersion, other.RowVersion) && Date == other.Date && IsEqualsWith(Designation, other.Designation) && IsEqualsWith(Description, other.Description) && IsEqualsWith(Currency, other.Currency) && IsEqualsWith(Members, other.Members) && IsEqualsWith(Category, other.Category);
		}
		public override int GetHashCode()
		{
			return HashCode.Combine(Id, RowVersion, Date, Designation, Description, Currency, HashCode.Combine(Members, Category));
		}
	}
}
namespace QnSCommunityCount.Logic.Entities.Persistence.App
...
namespace QnSCommunityCount.Logic.Entities.Persistence.App
{
	...
	partial class CostRecord : QnSCommunityCount.Contracts.Persistence.App.ICostRecord
	{
		...
		protected bool Equals(QnSCommunityCount.Contracts.Persistence.App.ICostRecord other)
		{
			...
			return Id == other.Id && IsEqualsWith(RowVersion, other.RowVersion) && CostCollectionId == other.CostCollectionId && Date == other.Date && IsEqualsWith(Designation, other.Designation) && Amount == other.Amount && IsEqualsWith(Member, other.Member);
		}
		public override int GetHashCode()
		{
			return HashCode.Combine(Id, RowVersion, CostCollectionId, Date, Designation, Amount, HashCode.Combine(Member));
		}
	}
}
namespace QnSCommunityCount.Logic.Entities.Persistence.App

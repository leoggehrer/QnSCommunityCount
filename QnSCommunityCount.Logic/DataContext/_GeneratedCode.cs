namespace QnSCommunityCount.Logic.DataContext.Db
{
	...
	partial class QnSCommunityCountDbContext : GenericDbContext
	{
		...
		partial void DoModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Entities.Persistence.App.CostCollection>().Property(p => p.RowVersion).IsRowVersion();
			...
			modelBuilder.Entity<Entities.Persistence.App.CostRecord>().Property(p => p.RowVersion).IsRowVersion();

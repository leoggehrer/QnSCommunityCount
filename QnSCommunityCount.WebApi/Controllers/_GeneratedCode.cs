namespace QnSCommunityCount.WebApi.Controllers
{
	...
	using Contract = Contracts.Persistence.App.ICostCollection;
	using Model = Transfer.Persistence.App.CostCollection;
	[ApiController]
	[Route("Controller")]
	public partial class CostCollectionController : GenericController<Contract, Model>
	{
...
namespace QnSCommunityCount.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = Contracts.Persistence.App.ICostRecord;
	using Model = Transfer.Persistence.App.CostRecord;
	[ApiController]
	[Route("Controller")]
	public partial class CostRecordController : GenericController<Contract, Model>
	{
		[HttpGet("/api/[controller]/MaxPageSize")]
		public Task<int> GetMaxPageAsync()
		{
...
namespace QnSCommunityCount.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = Contracts.Business.App.ICommunityCosts;
	using Model = Transfer.Business.App.CommunityCosts;
	[ApiController]
	[Route("Controller")]
	public partial class CommunityCostsController : GenericController<Contract, Model>
	{
		[HttpGet("/api/[controller]/MaxPageSize")]
		public Task<int> GetMaxPageAsync()
		{

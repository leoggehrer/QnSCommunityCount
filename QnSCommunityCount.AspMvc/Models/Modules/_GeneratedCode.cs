namespace QnSCommunityCount.AspMvc.Models.Modules.Language
{
	public partial class Translation : QnSCommunityCount.Contracts.Modules.Language.ITranslation
	{
		static Translation()
		{
			ClassConstructing();
...
namespace QnSCommunityCount.AspMvc.Models.Modules.App
{
	public partial class Balance : QnSCommunityCount.Contracts.Modules.App.IBalance
	{
		static Balance()
		{
			ClassConstructing();
...
namespace QnSCommunityCount.AspMvc.Models.Modules.App
{
	partial class Balance : ModelObject
	{
	}
}
